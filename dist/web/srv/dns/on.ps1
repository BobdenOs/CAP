...
netsh interface ipv4 add dnsservers "Wi-Fi" 172.28.218.112 index=1
netsh interface ipv4 add dnsservers "Wi-Fi" 192.168.0.1 index=2

# netsh interface ipv6 set dnsservers "Ethernet" static none
netsh interface ipv6 delete dnsservers "Wi-Fi" all
netsh interface ipv6 set dnsservers "Wi-Fi" static fd14:c9c1:a1a7:1::aaaa
