...
export default (function (exports, module, require, __dirname, __filename) {
  ...
  function _deserializeBatchResponse(sContentType, sResponseBody, bIsChangeSet) {
    ...
    aBatchParts.forEach(function (sBatchPart) {
      ...
      // inluce both request and response values
      oResponse.method = aHttpStatusInfos[0];
      oResponse.url = aHttpStatusInfos[1];
      ...
      oResponse.body = oResponse.responseText = sBatchPart.slice(iHttpHeadersEnd + 4, -2);
  ...
  function _serializeBatchResponse(aRequests, iChangeSetIndex, sEpilogue, bIgnoreETag) {
    var sBatchBoundary = (iChangeSetIndex !== undefined ? "changeset_" : "batch_")
      + crypto.randomUUID(),
      bIsChangeSet = iChangeSetIndex !== undefined,
      aRequestBody = [];
    ...
    aRequests.forEach(function (oRequest, iRequestIndex) {
      ...
      if (Array.isArray(oRequest)) {
        ...
        aRequestBody = aRequestBody.concat(
          _serializeBatchResponse(oRequest, iRequestIndex, "", bIgnoreETag).body);
      } else {
        if (bIsChangeSet && !mAllowedChangeSetMethods[oRequest.method]) {
          throw new Error("Invalid HTTP request method: " + oRequest.method
            + ". Change set must contain only POST, PUT, PATCH, or DELETE requests.");
        ...
        aRequestBody = aRequestBody.concat(
          ...
          sContentIdHeader,
          "\r\n",
          "HTTP/1.1 ", oRequest.status, " ", oRequest.statusText, "\r\n",
          serializeHeaders(oRequest.headers),
          "\r\n",
          JSON.stringify(oRequest.body) || "", "\r\n");
      }
  ...
  module.exports = {
    ...
    serializeBatchResponse: function (aRequests, sEpilogue, bIgnoreETag) {
      var oBatchRequest
        = _serializeBatchResponse(aRequests, undefined, sEpilogue, bIgnoreETag);
