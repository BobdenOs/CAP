import __IMPORT_3__ from '/web/node_modules/@sap/cds/libx/_runtime/common/utils/keys.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds/libx/_runtime/common/utils/propagateForeignKeys.js'
import __IMPORT_1__ from '/web/node_modules/@cap-js/db-service/lib/deep-queries.js'
...
const { hasDeep } = __IMPORT_1__()

// REVISIT: very deep & fragile dependencies to internal modules -> copy these into here
const propagateForeignKeys = __IMPORT_2__()
const { enrichDataWithKeysFromWhere } = __IMPORT_3__()
