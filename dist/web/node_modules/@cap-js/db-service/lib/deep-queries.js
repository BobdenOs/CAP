import __IMPORT_2__ from '/web/node_modules/@sap/cds/libx/_runtime/common/utils/compareJson.js'
...
const { _target_name4 } = __IMPORT_1__()
...
const compareJson = (...args) => {
  if (!_compareJson) {
    try {
      // new path
      _compareJson = __IMPORT_2__().compareJson
    } catch {
      // old path
      _compareJson = ({}).compareJson
    }
  }
