import __IMPORT_9__ from '/web/node_modules/@cap-js/db-service/lib/cqn2sql.js'
import __IMPORT_8__ from '/web/node_modules/@cap-js/db-service/lib/InsertResults.js'
import __IMPORT_7__ from '/web/node_modules/@cap-js/db-service/lib/deep-queries.js'
import __IMPORT_6__ from '/web/node_modules/@cap-js/db-service/lib/fill-in-keys.js'
import __IMPORT_5__ from '/web/node_modules/@cap-js/db-service/lib/cqn4sql.js'
import __IMPORT_4__ from '/web/node_modules/@cap-js/db-service/lib/common/DatabaseService.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds/libx/_runtime/common/utils/resolveView.js'
import __IMPORT_2__ from '/web/node/stream/promises.mjs'
...
const { Readable, Transform } = __IMPORT_1__
const { pipeline } = __IMPORT_2__
const { resolveView, getDBTable, getTransition } = __IMPORT_3__()
const DatabaseService = __IMPORT_4__()
const cqn4sql = __IMPORT_5__()
...
class SQLService extends DatabaseService {
  init() {
    this.on(['INSERT', 'UPSERT', 'UPDATE'], __IMPORT_6__()) // REVISIT should be replaced by correct input processing eventually
    this.on(['INSERT', 'UPSERT', 'UPDATE'], __IMPORT_7__().onDeep)
