import __IMPORT_2__ from '/web/node_modules/@sap/cds/bin/args.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds/app/etc/livereload.js'
...
const cds = __IMPORT_0__(), { exists, isfile, local, redacted, path } = cds.utils
...
async function serve (all=[], o={}) {
  ...
  const {features} = cds.env
  {
    ...
    if (features.live_reload) __IMPORT_1__()
...
exports.exec = function cds_serve (...argv) {
  try {
    const [ args, options ] = __IMPORT_2__() (serve, argv)
