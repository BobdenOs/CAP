import __IMPORT_4__ from '/web/node_modules/@sap/cds/app/index.js'
import __IMPORT_3__ from '/web/node/os.mjs'
import __IMPORT_2__ from '/web/node/cluster.mjs'
import __IMPORT_1__ from '/web/node_modules/@sap/cds/lib/index.js'
import __IMPORT_0__ from '/web/node_modules/express/index.js'
...
module.exports = async function cds_server (options) {
  ...
  if (WORKERS) {
    ...
    const cluster = __IMPORT_2__
    if (cluster.isMaster) {
      if (WORKERS in {true:1}) WORKERS = __IMPORT_3__.availableParallelism()
