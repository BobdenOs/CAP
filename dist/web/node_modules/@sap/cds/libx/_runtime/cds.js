import __IMPORT_4__ from 'common/aspects/service.js'
import __IMPORT_3__ from 'common/aspects/entity.js'
import __IMPORT_2__ from 'common/aspects/Association.js'
import __IMPORT_1__ from 'common/aspects/any.js'
...
cds.extend(any).with(__IMPORT_1__())
cds.extend(Association).with(__IMPORT_2__())
cds.extend(entity).with(__IMPORT_3__())
cds.extend(service).with(__IMPORT_4__())
