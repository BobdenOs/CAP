import __IMPORT_3__ from '/web/node_modules/@sap/cds/libx/_runtime/fiori/lean-draft.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds/libx/_runtime/common/utils/templateProcessorPathSerializer.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds/libx/_runtime/common/utils/template.js'
...
const getTemplate = __IMPORT_1__()
const templatePathSerializer = __IMPORT_2__()

const $has_asserts = Symbol.for('has_asserts')

const { compileUpdatedDraftMessages } = __IMPORT_3__()
