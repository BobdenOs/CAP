import __IMPORT_9__ from '/web/node_modules/@sap/cds/lib/req/event.js'
import __IMPORT_8__ from '/web/node_modules/@sap/cds/libx/http/location.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds/lib/req/response.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds/libx/odata/middleware/error.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds/libx/_runtime/common/utils/streamProp.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds/libx/_runtime/common/utils/etag.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds/libx/_runtime/common/generic/sorting.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds/libx/_runtime/common/generic/paging.js'
import __IMPORT_1__ from '/web/node/stream.mjs'
...
const { Readable, PassThrough } = __IMPORT_1__

const { getPageSize, commonGenericPaging } = __IMPORT_2__()
const { handler: commonGenericSorting } = __IMPORT_3__()
const { addEtagColumns } = __IMPORT_4__()
const { handleStreamProperties } = __IMPORT_5__()

const { getLocalizedMessages } = __IMPORT_6__()
const { Responses, prepareError } = __IMPORT_7__()
const location4 = __IMPORT_8__()

const $original = Symbol('original')
const $draftParams = Symbol('draftParams')

const { WELL_KNOWN_EVENTS } = __IMPORT_9__()
