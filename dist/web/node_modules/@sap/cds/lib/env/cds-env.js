import __IMPORT_9__ from '/web/node_modules/@sap/cds/lib/compile/etc/properties.js'
import __IMPORT_8__ from '/web/node_modules/js-yaml/index.js'
import __IMPORT_7__ from '/web/node/util.mjs'
import __IMPORT_6__ from '/web/node_modules/@sap/cds/lib/env/serviceBindings.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds/lib/index.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds/lib/plugins.js'
import __IMPORT_3__ from '/web/node/os.mjs'
import __IMPORT_2__ from '/web/node_modules/@sap/cds/lib/env/compat.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds/lib/env/defaults.js'
import __IMPORT_0__ from '/web/node_modules/@sap/cds/lib/utils/cds-utils.js'
...
const { isdir, isfile, fs, path } = __IMPORT_0__()
const DEFAULTS = __IMPORT_1__(), defaults = require.resolve ('./defaults')
const compat = __IMPORT_2__()
...
class Config {
  ...
  constructor (_context, _home, _defaults=true) {
    ...
    if (_context !== 'cds') {
      ...
      const user_ = process.env.CDS_USER_HOME || __IMPORT_3__.homedir()
  ...
  get plugins() {
    return super.plugins = __IMPORT_4__().fetch()
  }
  ...
  get tmp() { return super.tmp = __IMPORT_3__.tmpdir() }
   ...
   */
  get effective(){
    return super.effective = __IMPORT_5__().compiler._options.for.env()
  }
  ...
  _add_cloud_service_bindings({ VCAP_SERVICES, VCAP_SERVICES_FILE_PATH, SERVICE_BINDING_ROOT }) {
    ...
    if (!bindings && SERVICE_BINDING_ROOT) {
      bindings = __IMPORT_6__()(SERVICE_BINDING_ROOT)
...
//
  ...
  _find_credentials_for_required_service(service, conf, vcaps) {
    ...
    function _array(o,p) {
      ...
      throw new Error(`Expected VCAP entry '${p}' to be an array, but was: ${__IMPORT_7__.inspect(vcaps)}`)
    }
  }
...
function _readYaml (file) {
  if (isfile(file)) {
    const YAML = _readYaml.parser ??= __IMPORT_8__()
...
function _readEnv (file) {
  if (isfile(file)) {
    const ENV = _readEnv.parser ??= __IMPORT_9__()
