...
import __IMPORT_1__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/index.js'
...
exports.properties = (...args) => (exports.properties = __IMPORT_2__().read) (...args)
exports.yaml = (file) => (exports.yaml = __IMPORT_3__().read) (file)
exports.csv = (file) => (exports.csv = __IMPORT_4__().read) (file)
