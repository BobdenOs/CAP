import __IMPORT_3__ from '/web/node_modules/@sap/cds/lib/compile/to/edm-files.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds/lib/compile/for/flows.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds/lib/compile/cdsc.js'
...
const cdsc = __IMPORT_1__()
const TRACE = cds.debug('trace')

const { enhanceCSNwithFlowAnnotations4FE  } = __IMPORT_2__()
...
if (cds.env.features.pre_compile_edmxs) {
  cds_compile_to_edmx.files = __IMPORT_3__()
} else {
