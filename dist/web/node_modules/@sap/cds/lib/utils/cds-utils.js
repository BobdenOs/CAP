import __IMPORT_12__ from '/web/node/url.mjs'
import __IMPORT_11__ from '/web/node_modules/@sap/cds/lib/utils/csv-reader.js'
import __IMPORT_10__ from '/web/node/fs.mjs'
import __IMPORT_9__ from '/web/node/path.mjs'
import __IMPORT_8__ from '/web/node_modules/@sap/cds/lib/utils/version.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds/lib/utils/tar-lib.js'
import __IMPORT_6__ from '/web/node_modules/js-yaml/index.js'
import __IMPORT_5__ from '/web/node/crypto.mjs'
import __IMPORT_4__ from '/web/node/util.mjs'
import __IMPORT_3__ from '/web/node_modules/@sap/cds/lib/utils/inflect.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds/lib/utils/colors.js'
import __IMPORT_1__ from '/web/node_modules/tar/dist/commonjs/index.js'
...
const _tarLib = () => { try { return __IMPORT_1__() } catch(err) {debugger} }

exports = module.exports = new class {
  get colors() { return super.colors = __IMPORT_2__() }
  get inflect() { return super.inflect = __IMPORT_3__() }
  get inspect() {
    const options = { depth: 11, colors: this.colors.enabled }
    const {inspect} = __IMPORT_4__
    return super.inspect = v => inspect(v,options)
  }
  get format() {
    const {format} = __IMPORT_4__
    return super.format = format
  }
  get uuid() { return super.uuid = __IMPORT_5__.randomUUID }
  get yaml() { const yaml = __IMPORT_6__(); return super.yaml = Object.assign(yaml,{parse:yaml.load}) }
  get tar()  { return super.tar = __IMPORT_7__() }
  get semver() { return super.semver = __IMPORT_8__() }
}

/** @type {import('node:path')} */
const path = exports.path = __IMPORT_9__, { dirname, join, resolve, relative } = path

/** @type {import('node:fs')} */
const fs = exports.fs = Object.assign (exports,__IMPORT_10__) //> for compatibility
...
exports._import = id => {
  try {
    ...
    // else try w/ ESM
    const { pathToFileURL } = __IMPORT_12__
