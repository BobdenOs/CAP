import __IMPORT_3__ from '../../../../../node/readline.mjs'
import __IMPORT_2__ from '../index.js'
...
const { createReadStream, createWriteStream, promises: fsp } = __IMPORT_0__
...
function _filterLines({ delimiter, trimWhitespaces }, input, out, filter) {
  return new Promise((resolve, reject) => {
    const rl = __IMPORT_3__.createInterface({ input, crlfDelay: Infinity })
