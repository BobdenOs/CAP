import __IMPORT_3__ from '../../../../../better-sqlite3/lib/index.js'
import __IMPORT_2__ from '../../../../../../node/util.mjs'
import __IMPORT_1__ from '../../../../../../node/perf_hooks.mjs'
...
const cds = __IMPORT_0__(), { decodeURIComponent } = cds.utils
...
if (!LOG._debug) module.exports = ()=>[]; else {
  ...
  const { performance } = __IMPORT_1__
  const { format } = __IMPORT_2__
...
function _instrument_better_sqlite (_get_perf) {
  ...
  const sqlite = __IMPORT_3__().prototype
