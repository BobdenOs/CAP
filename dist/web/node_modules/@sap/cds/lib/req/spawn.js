...
import __IMPORT_1__ from '/web/node_modules/@sap/cds/lib/req/context.js'
...
const { EventEmitter } = __IMPORT_0__
const EventContext = __IMPORT_1__()
  ...
  const fx = ()=>{
    ...
    return cds._with (tx, async ()=> {
      ...
      if (cds.model && (cds.env.requires.extensibility || cds.env.requires.toggles)) {
        ...
        const ExtendedModels = __IMPORT_2__() // the sentinel is automatically started when required
