import __IMPORT_2__ from '/web/node_modules/@sap/cds/lib/ql/cds.ql-infer.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds/lib/index.js'
import __IMPORT_0__ from '/web/node_modules/@sap/cds/lib/core/types.js'
...
const { types, classes } = __IMPORT_0__()
...
class LinkedCSN {
  ...
  constructor (x,...etc) {
    ...
    if (x.raw) x = __IMPORT_1__().compile(String.raw(x,...etc)) //> for convenience in repl
    else if (typeof x === 'string') x = __IMPORT_1__().compile(x) //> for convenience in repl
