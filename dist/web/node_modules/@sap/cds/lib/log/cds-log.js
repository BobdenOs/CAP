import __IMPORT_5__ from '/web/node_modules/@sap/cds/lib/log/service/index.js'
import __IMPORT_4__ from '/web/node/path.mjs'
import __IMPORT_3__ from '/web/node_modules/@sap/cds/lib/log/format/json.js'
import __IMPORT_2__ from '/web/node/util.mjs'
import __IMPORT_1__ from '/web/node_modules/winston/lib/winston.js'
...
const cds = __IMPORT_0__(), defaults = { format: 'plain', levels: {} }
 ...
 */
 exports.formatters = new class {
  ...
  get json() { return super.json = __IMPORT_3__() }
}
...
function _init() {
  ...
  if (conf.service) {
    const {app} = cds, serveIn = app => __IMPORT_5__().serveIn(app)
