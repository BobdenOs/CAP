import __IMPORT_11__ from '/web/node_modules/@sap/cds-compiler/lib/transform/transformUtils.js'
import __IMPORT_10__ from '/web/node_modules/@sap/cds-compiler/lib/gen/Dictionary.js'
import __IMPORT_9__ from '/web/node_modules/@sap/cds-compiler/lib/utils/objectUtils.js'
import __IMPORT_8__ from '/web/node_modules/@sap/cds-compiler/lib/model/cloneCsn.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds-compiler/lib/transform/odata/toFinalBaseType.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/transform/odata/typesExposure.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/edm/edmInboundChecks.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/edm/edmAnnoPreprocessor.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/edm/edmUtils.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/base/builtins.js'
...
const { isBuiltinType, isMagicVariable } = __IMPORT_2__();
const edmUtils = __IMPORT_3__();
const edmAnnoPreproc = __IMPORT_4__();
const { inboundQualificationChecks } = __IMPORT_5__();
const typesExposure = __IMPORT_6__();
const expandCSNToFinalBaseType = __IMPORT_7__();
const { cloneCsnNonDict, cloneAnnotationValue } = __IMPORT_8__();
const { forEach, forEachKey } = __IMPORT_9__();
...
const capabilities = Object.keys(__IMPORT_10__()
...
function initializeModel( csn, _options, messageFunctions, requestedServiceNames = undefined ) {
  ...
  */
  if (csn.meta && csn.meta.options && csn.meta.options.odataVersion === 'v4' && options.isV2()) {
    const { toFinalBaseType } = __IMPORT_11__().getTransformers(csn, options, messageFunctions);
