import __IMPORT_17__ from '/web/node_modules/@sap/cds-compiler/lib/model/xprAsTree.js'
import __IMPORT_16__ from '/web/node_modules/@sap/cds-compiler/lib/render/utils/operators.js'
import __IMPORT_15__ from '/web/node_modules/@sap/cds-compiler/lib/model/csnRefs.js'
import __IMPORT_14__ from '/web/node_modules/@sap/cds-compiler/lib/base/error.js'
import __IMPORT_13__ from '/web/node_modules/@sap/cds-compiler/lib/render/utils/unique.js'
import __IMPORT_12__ from '/web/node_modules/@sap/cds-compiler/lib/render/manageConstraints.js'
import __IMPORT_11__ from '/web/node_modules/@sap/cds-compiler/lib/model/cloneCsn.js'
import __IMPORT_10__ from '/web/node_modules/@sap/cds-compiler/lib/sql-identifier.js'
import __IMPORT_9__ from '/web/node_modules/@sap/cds-compiler/lib/base/model.js'
import __IMPORT_8__ from '/web/node_modules/@sap/cds-compiler/lib/utils/timetrace.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds-compiler/lib/json/csnVersion.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/render/DuplicateChecker.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/render/utils/sql.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/render/utils/delta.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/render/utils/common.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/utils/objectUtils.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds-compiler/lib/base/builtins.js'
...
const { isBuiltinType, isMagicVariable } = __IMPORT_1__();
const { forEach, forEachValue, forEachKey } = __IMPORT_2__();
const {
...
const DuplicateChecker = __IMPORT_6__();
const { checkCSNVersion } = __IMPORT_7__();
const { timetrace } = __IMPORT_8__();
const { isBetaEnabled, isDeprecatedEnabled } = __IMPORT_9__();
const sqlIdentifiers = __IMPORT_10__();
const { sortCsn } = __IMPORT_11__();
const { manageConstraints, manageConstraint } = __IMPORT_12__();
const { renderUniqueConstraintString, renderUniqueConstraintDrop, renderUniqueConstraintAdd } = __IMPORT_13__();
const { ModelError, CompilerAssertion } = __IMPORT_14__();
const { pathId } = __IMPORT_15__();
const { transformExprOperators } = __IMPORT_16__();
const { exprAsTree, condAsTree } = __IMPORT_17__();
