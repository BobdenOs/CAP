import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/api/options.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/model/cloneCsn.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/render/utils/sql.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/transform/forRelationalDB.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds-compiler/lib/utils/objectUtils.js'
...
const { forEach } = __IMPORT_1__();
const { transformForRelationalDBWithCsn } = __IMPORT_2__();

const {
  renderReferentialConstraint, getIdentifierUtils,
} = __IMPORT_3__();
const { sortCsn } = __IMPORT_4__();
...
function _transformSqlOptions( csn, options ) {
  ...
  const prepareOptions = __IMPORT_5__();
