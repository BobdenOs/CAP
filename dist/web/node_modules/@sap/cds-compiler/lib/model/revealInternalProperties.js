...
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/model/revealInternalProperties.js'
...
// __IMPORT_2__().log(model, 'E_purposes')
function logXsnModel( model, name ) {
  // eslint-disable-next-line no-console
  console.log( __IMPORT_3__.inspect( revealInternalProperties( model, name ), false, null ) );
}

// To be used for tracing, e.g. by
// console.log(__IMPORT_2__().ref(type._artifact))
