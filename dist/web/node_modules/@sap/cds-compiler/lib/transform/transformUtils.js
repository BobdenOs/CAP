import __IMPORT_8__ from '/web/node_modules/@sap/cds-compiler/lib/transform/tupleExpansion.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds-compiler/lib/transform/addTenantFields.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/model/cloneCsn.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/utils/objectUtils.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/base/error.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/base/builtins.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/builtins.js'
...
const { setProp } = __IMPORT_0__();

const { copyAnnotations, applyTransformations, isDeepEqual } = __IMPORT_1__();
const { getUtils } = __IMPORT_1__();
const { typeParameters } = __IMPORT_2__();
const { isBuiltinType } = __IMPORT_3__();
const { ModelError, CompilerAssertion } = __IMPORT_4__();
const { forEach } = __IMPORT_5__();
const { cloneCsnNonDict, cloneCsnDict } = __IMPORT_6__();
const { addTenantFieldToArt } = __IMPORT_7__();
const { tupleExpansion } = __IMPORT_8__();
