import __IMPORT_19__ from '/web/node_modules/@sap/cds-compiler/lib/base/builtins.js'
import __IMPORT_18__ from '/web/node_modules/@sap/cds-compiler/lib/transform/odata/foreignKeyRefsInXprAnnos.js'
import __IMPORT_17__ from '/web/node_modules/@sap/cds-compiler/lib/model/csnRefs.js'
import __IMPORT_16__ from '/web/node_modules/@sap/cds-compiler/lib/model/cloneCsn.js'
import __IMPORT_15__ from '/web/node_modules/@sap/cds-compiler/lib/transform/localized.js'
import __IMPORT_14__ from '/web/node_modules/@sap/cds-compiler/lib/transform/addTenantFields.js'
import __IMPORT_13__ from '/web/node_modules/@sap/cds-compiler/lib/transform/draft/odata.js'
import __IMPORT_12__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/expansion.js'
import __IMPORT_11__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/associations.js'
import __IMPORT_10__ from '/web/node_modules/@sap/cds-compiler/lib/transform/odata/createForeignKeys.js'
import __IMPORT_9__ from '/web/node_modules/@sap/cds-compiler/lib/transform/odata/flattening.js'
import __IMPORT_8__ from '/web/node_modules/@sap/cds-compiler/lib/transform/universalCsn/universalCsnEnricher.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds-compiler/lib/utils/timetrace.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/transform/odata/toFinalBaseType.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/transform/odata/utils.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/checks/validator.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/json/csnVersion.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/model/csnUtils.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds-compiler/lib/transform/transformUtils.js'
...
const { isBetaEnabled } = __IMPORT_0__();
const transformUtils = __IMPORT_1__();
const {
  forEachDefinition,
...
const { checkCSNVersion } = __IMPORT_3__();
const validate = __IMPORT_4__();
const { isArtifactInSomeService, isLocalizedArtifactInService } = __IMPORT_5__();
const expandToFinalBaseType = __IMPORT_6__();
const { timetrace } = __IMPORT_7__();
const enrichUniversalCsn = __IMPORT_8__();
const flattening = __IMPORT_9__();
const createForeignKeyElements = __IMPORT_10__();
const associations = __IMPORT_11__();
const expansion = __IMPORT_12__();
const generateDrafts = __IMPORT_13__();

const { addTenantFields } = __IMPORT_14__();
const { addLocalizationViews } = __IMPORT_15__();
const { cloneFullCsn } = __IMPORT_16__();
const { csnRefs } = __IMPORT_17__();
const replaceForeignKeyRefsInExpressionAnnotations = __IMPORT_18__();
const { isAnnotationExpression, xprInAnnoProperties } = __IMPORT_19__();
