...
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/model/xprAsTree.js'
...
const { applyTransformations, isDollarSelfOrProjectionOperand, implicitAs } = __IMPORT_1__();
const { isBuiltinType } = __IMPORT_2__();
const { condAsTree } = __IMPORT_3__();
const { pathToMessageString } = __IMPORT_4__();
const { pathId } = __IMPORT_5__();
