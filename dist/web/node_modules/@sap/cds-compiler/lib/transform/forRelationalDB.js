import __IMPORT_29__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/processSqlServices.js'
import __IMPORT_28__ from '/web/node_modules/@sap/cds-compiler/lib/model/cloneCsn.js'
import __IMPORT_27__ from '/web/node_modules/@sap/cds-compiler/lib/transform/featureFlags.js'
import __IMPORT_26__ from '/web/node_modules/@sap/cds-compiler/lib/render/utils/common.js'
import __IMPORT_25__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/backlinks.js'
import __IMPORT_24__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/associations.js'
import __IMPORT_23__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/temporal.js'
import __IMPORT_22__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/cdsPersistence.js'
import __IMPORT_21__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/views.js'
import __IMPORT_20__ from '/web/node_modules/@sap/cds-compiler/lib/transform/universalCsn/universalCsnEnricher.js'
import __IMPORT_19__ from '/web/node_modules/@sap/cds-compiler/lib/transform/draft/db.js'
import __IMPORT_18__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/assertUnique.js'
import __IMPORT_17__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/expansion.js'
import __IMPORT_16__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/flattening.js'
import __IMPORT_15__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/groupByOrderBy.js'
import __IMPORT_14__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/rewriteCalculatedElements.js'
import __IMPORT_13__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/assocsToQueries/transformExists.js'
import __IMPORT_12__ from '/web/node_modules/@sap/cds-compiler/lib/utils/objectUtils.js'
import __IMPORT_11__ from '/web/node_modules/@sap/cds-compiler/lib/transform/db/constraints.js'
import __IMPORT_10__ from '/web/node_modules/@sap/cds-compiler/lib/utils/timetrace.js'
import __IMPORT_9__ from '/web/node_modules/@sap/cds-compiler/lib/transform/localized.js'
import __IMPORT_8__ from '/web/node_modules/@sap/cds-compiler/lib/transform/addTenantFields.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds-compiler/lib/checks/selectItems.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/checks/validator.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/json/csnVersion.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/model/csnRefs.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/transform/translateAssocsToJoins.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/transform/transformUtils.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds-compiler/lib/model/csnUtils.js'
import __IMPORT_0__ from '/web/node_modules/@sap/cds-compiler/lib/base/model.js'
...
const { setProp, isBetaEnabled } = __IMPORT_0__();
const {
...
const transformUtils = __IMPORT_2__();
const { translateAssocsToJoinsCSN } = __IMPORT_3__();
const {
  csnRefs, pathId, traverseQuery, columnAlias,
} = __IMPORT_4__();
const { checkCSNVersion } = __IMPORT_5__();
const validate = __IMPORT_6__();
const { rejectManagedAssociationsAndStructuresForHdbcdsNames } = __IMPORT_7__();
const { addTenantFields } = __IMPORT_8__();
const { addLocalizationViewsWithJoins, addLocalizationViews } = __IMPORT_9__();
const { timetrace } = __IMPORT_10__();
const { createReferentialConstraints, assertConstraintIdentifierUniqueness } = __IMPORT_11__();
const { forEach } = __IMPORT_12__();
const handleExists = __IMPORT_13__();
const { rewriteCalculatedElementsInViews, processCalculatedElementsInEntities } = __IMPORT_14__();
const replaceAssociationsInGroupByOrderBy = __IMPORT_15__();
const _forEachDefinition = __IMPORT_1__().forEachDefinition;
const flattening = __IMPORT_16__();
const expansion = __IMPORT_17__();
const assertUnique = __IMPORT_18__();
const generateDrafts = __IMPORT_19__();
const enrichUniversalCsn = __IMPORT_20__();
const { getViewTransformer, ensureColumnNames } = __IMPORT_21__();
const cdsPersistence = __IMPORT_22__();
const temporal = __IMPORT_23__();
const associations = __IMPORT_24__();
const backlinks = __IMPORT_25__();
const { getDefaultTypeLengths } = __IMPORT_26__();
const { featureFlags } = __IMPORT_27__();
const { cloneCsnNonDict, cloneFullCsn } = __IMPORT_28__();
const { processSqlServices, createServiceDummy } = __IMPORT_29__();
const { expandWildcard } = __IMPORT_17__();
