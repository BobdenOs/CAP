...
import __IMPORT_16__ from './service.js'
import __IMPORT_15__ from '../featureFlags.js'
import __IMPORT_14__ from '../../model/cloneCsn.js'
import __IMPORT_13__ from '../db/rewriteCalculatedElements.js'
import __IMPORT_12__ from './annotations.js'
import __IMPORT_11__ from './misc.js'
import __IMPORT_10__ from '../db/assocsToQueries/transformExists.js'
import __IMPORT_9__ from './associations.js'
import __IMPORT_8__ from './queries.js'
import __IMPORT_7__ from '../db/expansion.js'
import __IMPORT_6__ from '../../checks/validator.js'
import __IMPORT_5__ from '../localized.js'
import __IMPORT_4__ from './types.js'
import __IMPORT_3__ from '../db/flattening.js'
import __IMPORT_2__ from './flattening.js'
...
const effectiveFlattening = __IMPORT_2__();
const flattening = __IMPORT_3__();
const types = __IMPORT_4__();
// const { addLocalizationViews } = __IMPORT_5__();
const validate = __IMPORT_6__();
const expansion = __IMPORT_7__();
const queries = __IMPORT_8__();
const associations = __IMPORT_9__();
const handleExists = __IMPORT_10__();
const misc = __IMPORT_11__();
const annotations = __IMPORT_12__();
const { rewriteCalculatedElementsInViews, processCalculatedElementsInEntities } = __IMPORT_13__();
const { cloneFullCsn } = __IMPORT_14__();
const { featureFlags } = __IMPORT_15__();
const getServiceFilterFunction = __IMPORT_16__();
const { traverseQuery } = __IMPORT_17__();
const { expandWildcard } = __IMPORT_7__();
