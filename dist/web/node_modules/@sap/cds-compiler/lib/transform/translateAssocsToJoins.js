import __IMPORT_8__ from '/web/node_modules/@sap/cds-compiler/lib/model/revealInternalProperties.js'
import __IMPORT_7__ from '/web/node/util.mjs'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/base/error.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/utils/timetrace.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/json/to-csn.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/utils.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/index.js'
...
const { makeMessageFunction } = __IMPORT_1__();
const { recompileX } = __IMPORT_2__();
const { linkToOrigin, pathName } = __IMPORT_3__();
const { compactModel, compactExpr } = __IMPORT_4__();
const { deduplicateMessages } = __IMPORT_1__();
const { timetrace } = __IMPORT_5__();
...
function walkPath(node, env) {
  ...
  // else if(path) {
  //   var util = __IMPORT_7__;
  //   var { reveal } = __IMPORT_8__();
  // }
  return path;
}
