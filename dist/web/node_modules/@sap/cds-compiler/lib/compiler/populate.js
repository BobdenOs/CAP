import __IMPORT_7__ from '/web/node_modules/@sap/cds-compiler/lib/model/revealInternalProperties.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/builtins.js'
...
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/base/error.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/base/location.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds-compiler/lib/base/dictionaries.js'
...
const { weakLocation, weakRefLocation } = __IMPORT_2__();
const { CompilerAssertion } = __IMPORT_3__();

const { kindProperties } = __IMPORT_4__();
const {
  setLink,
  setArtifactLink,
  annotationVal,
...
const { typeParameters } = __IMPORT_6__();
...
function populate( model ) {
  ...
  function effectiveType( art ) {
    ...
    for (const a of chain) {
      ...
      // console.log('PE:',__IMPORT_7__().ref(a))
  ...
  function populateArtifact( art, origEffective ) {
    ...
    // console.log('PA:',__IMPORT_7__().ref(art))
