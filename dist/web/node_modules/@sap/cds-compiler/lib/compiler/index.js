import __IMPORT_23__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/xsn-model.js'
import __IMPORT_22__ from '/web/node/path.mjs'
import __IMPORT_21__ from '/web/node/fs.mjs'
import __IMPORT_20__ from '/web/node_modules/@sap/cds-compiler/lib/utils/file.js'
import __IMPORT_19__ from '/web/node_modules/@sap/cds-compiler/lib/base/node-helpers.js'
import __IMPORT_18__ from '/web/node_modules/@sap/cds-compiler/lib/base/model.js'
import __IMPORT_17__ from '/web/node_modules/@sap/cds-compiler/lib/base/messages.js'
import __IMPORT_16__ from '/web/node_modules/@sap/cds-compiler/lib/base/location.js'
import __IMPORT_15__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/checks.js'
import __IMPORT_14__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/propagator.js'
import __IMPORT_13__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/tweak-assocs.js'
import __IMPORT_12__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/resolve.js'
import __IMPORT_11__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/populate.js'
import __IMPORT_10__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/kick-start.js'
import __IMPORT_9__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/generate.js'
import __IMPORT_8__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/extend.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/finalize-parse-cdl.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/define.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/shared.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/moduleLayers.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/compiler/assert-consistency.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/json/from-csn.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds-compiler/lib/parsers/index.js'
import __IMPORT_0__ from '/web/node_modules/@sap/cds-compiler/lib/utils/moduleResolve.js'
...
const { makeModuleResolver, makeModuleResolverSync } = __IMPORT_0__();
const parsers = __IMPORT_1__();
const parseCsn = __IMPORT_2__();

const assertConsistency = __IMPORT_3__();
const moduleLayers = __IMPORT_4__();
const { fns } = __IMPORT_5__();
const define = __IMPORT_6__();
const finalizeParseCdl = __IMPORT_7__();
const extend = __IMPORT_8__();
const generate = __IMPORT_9__();
const kickStart = __IMPORT_10__();
const populate = __IMPORT_11__();
const resolve = __IMPORT_12__();
const tweakAssocs = __IMPORT_13__();
const propagator = __IMPORT_14__();
const check = __IMPORT_15__();

const { Location, emptyWeakLocation } = __IMPORT_16__();
const { createMessageFunctions, deduplicateMessages } = __IMPORT_17__();
const { checkRemovedDeprecatedFlags } = __IMPORT_18__();
const { promiseAllDoNotRejectImmediately } = __IMPORT_19__();
const { cdsFs, fileExtension } = __IMPORT_20__();

const fs = __IMPORT_21__;
const path = __IMPORT_22__;
const { XsnSource } = __IMPORT_23__();
