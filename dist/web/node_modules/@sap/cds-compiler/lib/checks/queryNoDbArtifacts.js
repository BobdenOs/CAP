...
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/checks/onConditions.js'
...
const { isPersistedOnDatabase, applyTransformationsOnNonDictionary } = __IMPORT_0__();
const { isBuiltinType } = __IMPORT_1__();
const { requireForeignKeyAccess } = __IMPORT_2__();
const { pathId } = __IMPORT_3__();
