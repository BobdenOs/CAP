import __IMPORT_30__ from '/web/node_modules/@sap/cds-compiler/lib/utils/timetrace.js'
import __IMPORT_29__ from '/web/node_modules/@sap/cds-compiler/lib/checks/featureFlags.js'
import __IMPORT_28__ from '/web/node_modules/@sap/cds-compiler/lib/checks/assocOutsideService.js'
import __IMPORT_27__ from '/web/node_modules/@sap/cds-compiler/lib/checks/sql-snippets.js'
import __IMPORT_26__ from '/web/node_modules/@sap/cds-compiler/lib/checks/managedWithoutKeys.js'
import __IMPORT_25__ from '/web/node_modules/@sap/cds-compiler/lib/checks/checkPathsInStoredCalcElement.js'
import __IMPORT_24__ from '/web/node_modules/@sap/cds-compiler/lib/checks/existsExpressionsOnlyForeignKeys.js'
import __IMPORT_23__ from '/web/node_modules/@sap/cds-compiler/lib/checks/existsMustEndInAssoc.js'
import __IMPORT_22__ from '/web/node_modules/@sap/cds-compiler/lib/checks/nullableKeys.js'
import __IMPORT_21__ from '/web/node_modules/@sap/cds-compiler/lib/checks/queryNoDbArtifacts.js'
import __IMPORT_20__ from '/web/node_modules/@sap/cds-compiler/lib/checks/arrayOfs.js'
import __IMPORT_19__ from '/web/node_modules/@sap/cds-compiler/lib/checks/invalidTarget.js'
import __IMPORT_18__ from '/web/node_modules/@sap/cds-compiler/lib/checks/elements.js'
import __IMPORT_17__ from '/web/node_modules/@sap/cds-compiler/lib/checks/types.js'
import __IMPORT_16__ from '/web/node_modules/@sap/cds-compiler/lib/checks/foreignKeys.js'
import __IMPORT_15__ from '/web/node_modules/@sap/cds-compiler/lib/checks/onConditions.js'
import __IMPORT_14__ from '/web/node_modules/@sap/cds-compiler/lib/checks/cdsMap.js'
import __IMPORT_13__ from '/web/node_modules/@sap/cds-compiler/lib/checks/annotationsOData.js'
import __IMPORT_12__ from '/web/node_modules/@sap/cds-compiler/lib/checks/actionsFunctions.js'
import __IMPORT_11__ from '/web/node_modules/@sap/cds-compiler/lib/checks/enums.js'
import __IMPORT_10__ from '/web/node_modules/@sap/cds-compiler/lib/checks/parameters.js'
import __IMPORT_9__ from '/web/node_modules/@sap/cds-compiler/lib/checks/structuredAnnoExpressions.js'
import __IMPORT_8__ from '/web/node_modules/@sap/cds-compiler/lib/checks/checkForTypes.js'
import __IMPORT_7__ from '/web/node_modules/@sap/cds-compiler/lib/checks/hasPersistedElements.js'
import __IMPORT_6__ from '/web/node_modules/@sap/cds-compiler/lib/checks/managedInType.js'
import __IMPORT_5__ from '/web/node_modules/@sap/cds-compiler/lib/checks/manyNavigations.js'
import __IMPORT_4__ from '/web/node_modules/@sap/cds-compiler/lib/checks/cdsPersistence.js'
import __IMPORT_3__ from '/web/node_modules/@sap/cds-compiler/lib/checks/defaultValues.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds-compiler/lib/checks/selectItems.js'
import __IMPORT_1__ from '/web/node_modules/@sap/cds-compiler/lib/checks/enricher.js'
import __IMPORT_0__ from '/web/node_modules/@sap/cds-compiler/lib/model/csnUtils.js'
...
const enrichCsn = __IMPORT_1__();

// forRelationalDB
const { validateSelectItems } = __IMPORT_2__();
const { rejectParamDefaultsInHanaCds, warnAboutDefaultOnAssociationForHanaCds } = __IMPORT_3__();
const validateCdsPersistenceAnnotation = __IMPORT_4__();
const navigationIntoMany = __IMPORT_5__();
const checkUsedTypesForAnonymousAspectComposition = __IMPORT_6__();
const validateHasPersistedElements = __IMPORT_7__();
const checkForHanaTypes = __IMPORT_8__();
const { checkAnnotationExpression } = __IMPORT_9__();
const checkForParams = __IMPORT_10__();
const checkAndRemoveEnums = __IMPORT_11__();
// forOdata
const { validateDefaultValues } = __IMPORT_3__();
const { checkActionOrFunction } = __IMPORT_12__();
const {
...
// both
const checkCdsMap = __IMPORT_14__();
const { validateOnCondition, validateMixinOnCondition } = __IMPORT_15__();
const validateForeignKeys = __IMPORT_16__();
const {
...
const checkForInvalidTarget = __IMPORT_19__();
const { validateAssociationsInItems } = __IMPORT_20__();
const checkQueryForNoDBArtifacts = __IMPORT_21__();
const checkExplicitlyNullableKeys = __IMPORT_22__();
const existsMustEndInAssoc = __IMPORT_23__();
const forbidAssocInExists = __IMPORT_24__();
const checkPathsInStoredCalcElement = __IMPORT_25__();
const managedWithoutKeys = __IMPORT_26__();
const {
  checkSqlAnnotationOnArtifact,
  checkSqlAnnotationOnElement,
} = __IMPORT_27__();
const assertNoAssocUsageOutsideOfService = __IMPORT_28__();
const featureFlags = __IMPORT_29__();
const { timetrace } = __IMPORT_30__();
