import __IMPORT_4__ from '/web/node/module.mjs'
import __IMPORT_3__ from '/web/node_modules/@cap-js/db-service/lib/cqn4sql.js'
import __IMPORT_2__ from '/web/node_modules/@sap/cds/lib/index.js'
import __IMPORT_1__ from '/web/node_modules/express/index.js'
...
const { Readable } = __IMPORT_0__
const express = __IMPORT_1__()

const cds = __IMPORT_2__();
const cqn4sql = __IMPORT_3__();
      ...
      if (isOffline) {
        for (const srv of model.services) {
          try {
            ...
            const resolve = __IMPORT_4__.createRequire(file).resolve
            const requires = {}
